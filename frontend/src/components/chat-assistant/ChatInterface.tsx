      ...
      >
        <div className="drag-handle text-center px-3 py-2 flex items-center justify-between bg-[rgb(255,255,255,.3)] rounded-t-2xl">
          <div className="text-white flex items-center justify-center gap-2 font-semibold">
            ...
            <div>
              <p className="text-xl font-stretch-110% font-semibold text-[#ffffff] tracking-wide drop-shadow-[0_0_10px_#eeffff">
                Charms
              </p>
            </div>
          </div>
          <div
            onClick={onClose}
            className="cursor-pointer text-2xl font-semibold text-white hover:bg-white/20 rounded-full p-1"
          >
            ×
          </div>
        </div>
